        ...
        <Route exact path="/" component={CardsPanel}>
          ...
          <section className="cards">
            ...
            <div className="cards_panel">
              {cards.map((card) => { return <Link onClick={setCountryPagePass(card.countryName)} to={pagePath}><CountryCard country={card} key={card.countryId} id={card.countryId} /> </Link> })}
            </div>
          </section>
        </Route>
        <Route exact path="/USA" component={() => <USA country={cards[13]} />} />
